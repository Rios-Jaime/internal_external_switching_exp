...
var jsPsych = initJsPsych({
  on_finish: function () {
    ...
    console.log("📩 Experiment data to be sent:", fullData);

    // ✅ Send data to the correct endpoint & ensure it saves before redirecting
    fetch("/save_data", {
      method: "POST",
      headers: {
      ...
      .then((response) => {
        if (response.ok) {
          ...
          // ✅ Redirect **ONLY AFTER** successful data save
